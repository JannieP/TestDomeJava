...
public class TestResults
{
    ...
    public static List<String> studentsThatPass(Stream<Student> students, int passingScore) {
        ...
        return students.filter(student -> student.getScore() >= passingScore).sorted(Comparator.comparingInt(Student::getScore).reversed()).map(Student::getName).collect(Collectors.toList());
